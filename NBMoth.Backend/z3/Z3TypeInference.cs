...
public class Z3TypeInference
    {
        Dictionary<TypedNode, Z3Type> types = new Dictionary<TypedNode, Z3Type>();
        Dictionary<DeclarationNode, Z3Type> declarationNodesTypes = new Dictionary<DeclarationNode, Z3Type>();
        ...
        public string getSetName()
{
    ...
    class Z3EnumeratedSetType : Z3Type
{
    string name;
