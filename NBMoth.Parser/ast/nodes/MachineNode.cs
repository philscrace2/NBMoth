...
namespace NBMoth.Parser.ast.nodes{
    ...
    private readonly List<string> warnings = new ArrayList<>();
    private readonly List<EnumeratedSetDeclarationNode> setEnumerations = new ArrayList<>();
    private readonly List<DeclarationNode> deferredSets = new ArrayList<>();
    private readonly List<LTLFormula> ltlFormulas = new ArrayList<>();
    ...
    public MachineNode(IParseTree parseTree, string name)
    {
